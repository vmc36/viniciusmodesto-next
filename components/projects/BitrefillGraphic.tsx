  ...
  return (
    <div className="h-[283px] bg-[#001413] rounded-xl relative overflow-hidden" ref={ref}>
      <Halo strength={resolvedTheme === 'light' ? 10 : 4}>
        <motion.div className="w-[257px] absolute right-4 z-10 -bottom-10" style={{ y }}>
          <Image src={bitrefillHome} alt="Bitrefill homepage" width={257} height={296} sizes="257px" />
        </motion.div>
        <svg width="111" height="28" fill="none" xmlns="http://www.w3.org/2000/svg" className="absolute hidden -translate-y-1/2 top-1/2 left-20 sm:block">
          <path
            fillRule="evenodd"
            clipRule="evenodd"
        ...
        <svg fill="none" height="251" width="150" xmlns="http://www.w3.org/2000/svg" className="absolute top-0 bottom-0 right-0 h-full">
          <path
