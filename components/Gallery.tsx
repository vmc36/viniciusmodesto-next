  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={cn(shared, 'bg-[#FFFAF2] flex items-center rounded-2xl overflow-hidden')}
          style={{
        ...
        >
          <Halo strength={50} className="flex items-center">
            ...
            <div className="z-[1] px-6">
              <div className={cn(ticketingFont.className, 'flex flex-col gap-1 uppercase')}>
  ...
  return (
    <>
      <section className="flex gap-4 h-[268px] relative">
        ...
        <Photo src={avatar} meta="2022-09-10" alt={'avatar'} width={190} height={253} rotate={7.6} left={587} index={4} flipDirection="left" />
      </section>
    </>
  );
}
